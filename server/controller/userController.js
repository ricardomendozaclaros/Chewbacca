  ...
  async getUsersByDateRange(req, res) {
    ...
    try {
      ...
      if (cachedData && !forceRefresh) {
        ...
        console.log(`🔄 Request URL: ${apiService.BASE_URL}/User/DataRange?startDate=${startDate}&endDate=${endDate}`);
        
        data = await apiService.fetchUsersByDateRange(startDate, endDate);
